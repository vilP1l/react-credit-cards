  ...
  _createClass(ReactCreditCards, [{
    ...
    value: function render() {
      var _this$props2 = this.props,
          ...
          redacted = _this$props2.redacted;
      ...
      }, !redacted || number.length < 4 ? number : ('*'.repeat(number.length - 3 - number.split(' ').length) + number.substring(number.length - 4)).split('').map(function (c, i) {
        return (i + 1) % 4 === 0 ? "".concat(c, " ") : c;
      }).join('').trim()), /*#__PURE__*/_react.default.createElement("div", {
...
_defineProperty(ReactCreditCards, "propTypes", {
  ...
  redacted: _propTypes.default.bool
});
